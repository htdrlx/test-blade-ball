...
do
	...
	getgenv()._Fallen_TB_Set = function(state)
		...
		if getgenv()._Fallen_Triggerbot_UI_Update then
			getgenv()._Fallen_Triggerbot_UI_Update()
		end
	end
	...
	triggerbot_module:create_checkbox({
		...
		callback = function(value)
			if value then
				if getgenv()._Fallen_Triggerbot_UI_Create then
					getgenv()._Fallen_Triggerbot_UI_Create()
				end
			else
				if getgenv()._Fallen_Triggerbot_UI_Destroy then
					getgenv()._Fallen_Triggerbot_UI_Destroy()
				end
			end
		end,
	})
...
do
	...
	local function create_triggerbot_ui()
		...
		local OverlayGui = Instance.new('ScreenGui')
		OverlayGui.Name = 'FallenTriggerbotOverlay'
		OverlayGui.ResetOnSpawn = false
		OverlayGui.IgnoreGuiInset = true
		...
		ToggleHit.Activated:Connect(function()
			if getgenv()._Fallen_TB_Set then
				getgenv()._Fallen_TB_Set(not getgenv().Triggerbot)
			end
		end)
	...
	getgenv()._Fallen_Triggerbot_UI_Create = create_triggerbot_ui
	getgenv()._Fallen_Triggerbot_UI_Destroy = destroy_triggerbot_ui
	getgenv()._Fallen_Triggerbot_UI_Update = update_triggerbot_ui
end
